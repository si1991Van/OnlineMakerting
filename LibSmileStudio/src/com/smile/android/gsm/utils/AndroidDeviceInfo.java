...
public class AndroidDeviceInfo {
	...
	public static String getDeviceID(Context context, String defaultValues) {
		...
		try {
			if (((manager = (TelephonyManager) context.getSystemService("phone")) != null) && (!TextUtils.isEmpty(manager.getDeviceId()))) {
	...
	public static String getNetworkType(Context context) {
		...
		if (context.checkCallingOrSelfPermission("android.permission.ACCESS_NETWORK_STATE") == 0) {
			try {
				if (((networkinfo = ((ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo()) != null) && (networkinfo.isConnectedOrConnecting())) {
					int i = networkinfo.getType();
					if (i == ConnectivityManager.TYPE_WIFI) {
						str = "WIFI";
					} else if (i == ConnectivityManager.TYPE_WIMAX) {
						str = "WIMAX";
					} else if ((i == ConnectivityManager.TYPE_MOBILE) || (i == ConnectivityManager.TYPE_MOBILE_DUN) || (i == ConnectivityManager.TYPE_MOBILE_HIPRI) || (i == ConnectivityManager.TYPE_MOBILE_MMS) || (i == ConnectivityManager.TYPE_MOBILE_SUPL)) {
